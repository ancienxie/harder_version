<?php include "./header.php"?>
    <div style="background-image: url(./images/ban-image.png);" class="ban-image">
        <section   class="ban-image__text">
            <h1 class="ban-image__text--title">Возвращение этнографа</h1>
            <p class="ban-image__text--info">Сегодня с Проксимы вернулась этнографическая экспедиция Джона Голдрама.</p>
        </section>
    </div>    
    <div class="main-info">
